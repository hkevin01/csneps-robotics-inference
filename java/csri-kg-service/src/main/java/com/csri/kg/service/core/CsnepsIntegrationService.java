...
/**
 * Service for integrating with CSNePS Clojure core.
...
public class CsnepsIntegrationService {
    ...
    private String csnepsHost;
    
    @Value("${csneps.port:50051}")
    private int csnepsPort;
    
    /**
     * Process a batch of assertions by forwarding to CSNePS core.
     */
    public AssertionResult processAssertions(List<Assertion> assertions) {
